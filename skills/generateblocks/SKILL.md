...
<figure class="gb-image gb-image-b87c2145">{{featured_image}}</figure>
<!-- /wp:generateblocks/image -->
...
<a class="gb-button gb-button-d49b460e gb-button-global-primary-button" href="#"> Button Text </a>
<!-- /wp:generateblocks/button -->
```
...
function my_register_gb_patterns()
{
	register_block_pattern('my-theme/hero-section', [
		...
		'categories' => ['generateblocks', 'featured'],
...
{
	register_block_pattern_category('my-theme-layouts', [
		'label' => __('My Theme Layouts', 'textdomain'),
	]);
}
```
