...
{
	register_post_type('my_prefix_product', [
		'labels' => [
	...
	register_taxonomy('product_category', 'my_prefix_product', [
		'labels' => [
...
{
	register_rest_route('my-prefix/v1', '/products', [
		'methods' => 'GET',
	...
	register_rest_route('my-prefix/v1', '/products/(?P<id>\d+)', [
		'methods' => 'GET',
