...
<div class="top-bar">
	<div class="grid-container">
		<span class="top-bar-phone"> <svg>...</svg> 123-456-7890 </span>
		<span class="top-bar-email"> <svg>...</svg> info@example.com </span>
	</div>
</div>
```
...
<header class="custom-header" itemtype="https://schema.org/WPHeader" itemscope>
	<div class="custom-header-inner grid-container">
		...
		<div class="header-row header-bottom">
			<nav class="main-navigation">{{primary_navigation}}</nav>
		</div>
	</div>
</header>
```
...
<header class="custom-header">
	...
	<div class="header-main-row">
		<div class="grid-container">
			...
			<div class="header-nav">{{primary_navigation}}</div>
			<div class="header-actions">{{navigation_search}} {{cart}}</div>
		</div>
	</div>
</header>
```
