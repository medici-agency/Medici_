...
(function ($) {
  ...
  const MediciForms = {
    ...
    validateForm: function ($form) {
      ...
      $form.find("[required]").each(function () {
        ...
        if (!value || (Array.isArray(value) && value.length === 0)) {
          isValid = false;
          MediciForms.showFieldError(
            $wrapper,
            mediciFormsConfig.i18n.required
          );
        }
      });
      ...
      $form.find('input[type="email"]').each(function () {
        ...
        if (value && !MediciForms.isValidEmail(value)) {
          ...
          MediciForms.showFieldError(
            $wrapper,
            mediciFormsConfig.i18n.invalidEmail
          );
        }
      });
      ...
      $form.find('input[type="tel"]').each(function () {
        ...
        if (value && !MediciForms.isValidPhone(value)) {
          ...
          MediciForms.showFieldError(
            $wrapper,
            mediciFormsConfig.i18n.invalidPhone
          );
        }
      });
    ...
    showFieldError: function ($wrapper, message) {
      ...
      $wrapper.append(
        '<span class="medici-form-field__error">' + message + "</span>"
      );
    },
    ...
    handleSuccess: function ($form, data) {
      ...
      if (data.message) {
        $form
          .find(".medici-form-message--success")
          .html(data.message)
          .slideDown();
      }
