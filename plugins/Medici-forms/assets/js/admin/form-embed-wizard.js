...
var WPFormsFormEmbedWizard =
	window.WPFormsFormEmbedWizard ||
	(function (document, window, $) {
		...
		var app = {
			...
			copyShortcodeToClipboard: function () {
				...
				el.$shortcodeInput.prop('disabled', false).select().prop('disabled', true);
			...
			initTooltip: function () {
				...
				var $dot = $('<span class="wpforms-admin-form-embed-wizard-dot">&nbsp;</span>'),
					...
					anchor = isGutenberg
						...
						: '#wp-content-editor-tools .wpforms-insert-form-button';
