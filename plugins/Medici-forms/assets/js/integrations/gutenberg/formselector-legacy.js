...
const wpformsIcon = createElement(
	'svg',
...
registerBlockType('wpforms/form-selector', {
	...
	edit(props) {
		...
		const {
			attributes: { formId = '', displayTitle = false, displayDesc = false, preview = false },
			setAttributes,
		} = props;
				...
				<Fragment key="wpforms-gutenberg-form-selector-fragment-block-empty">
					<div className="wpforms-no-form-preview">
						...
						<p
							...
							dangerouslySetInnerHTML={{ __html: strings.wpforms_empty_help }}
						></p>
			...
			<InspectorControls key="wpforms-gutenberg-form-selector-inspector-controls">
				<PanelBody title={wpforms_gutenberg_form_selector.strings.form_settings}>
					...
					<p className="wpforms-gutenberg-panel-notice wpforms-warning">
						...
						<a href={strings.update_wp_notice_link} rel="noreferrer" target="_blank">
							{strings.learn_more}
						</a>
					</p>
				</PanelBody>
