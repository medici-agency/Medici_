...
export default (function ($) {
	...
	const app = {
				...
				<InspectorAdvancedControls>
					<div className={app.common.getPanelClass(props) + ' advanced'}>
						...
						<div
							...
							dangerouslySetInnerHTML={{ __html: strings.custom_css_notice }}
						></div>
						<TextareaControl
						...
						<div
							className="wpforms-gutenberg-form-selector-legend"
							dangerouslySetInnerHTML={{ __html: strings.copy_paste_notice }}
						></div>
					</div>
				</InspectorAdvancedControls>
			);
		 ...
		 */
		withAdvancedControls: createHigherOrderComponent((BlockEdit) => {
			return (props) => {
				return (
					<Fragment>
						<BlockEdit {...props} />
