...
*/
		...
		3: [
			...
			{ './lib/ReactPropTypesSecret': 7, './lib/has': 8, hmr7eR: 1 },
		],
		4: [
			function (require, module, exports) {
				/**
		...
		11: [
			...
			{ './cjs/react-is.development.js': 9, './cjs/react-is.production.min.js': 10, hmr7eR: 1 },
		],
		12: [
			function (require, module, exports) {
				'use strict';

				var _education = _interopRequireDefault(
					require('../../../js/integrations/gutenberg/modules/education.js')
				);
				var _common = _interopRequireDefault(
					require('../../../js/integrations/gutenberg/modules/common.js')
				);
				var _themesPanel = _interopRequireDefault(
					require('../../../js/integrations/gutenberg/modules/themes-panel.js')
				);
				var _containerStyles = _interopRequireDefault(
					require('../../../js/integrations/gutenberg/modules/container-styles.js')
				);
				var _backgroundStyles = _interopRequireDefault(
					require('../../../js/integrations/gutenberg/modules/background-styles.js')
				);
				var _buttonStyles = _interopRequireDefault(
					require('../../../js/integrations/gutenberg/modules/button-styles.js')
				);
				var _advancedSettings = _interopRequireDefault(
					require('../../../js/integrations/gutenberg/modules/advanced-settings.js')
				);
				var _fieldStyles = _interopRequireDefault(
					require('../../../js/integrations/gutenberg/modules/field-styles.js')
				);
						...
						var app = {
							...
							getCommonAttributes: function getCommonAttributes() {
								return _objectSpread(
									_objectSpread(
										_objectSpread(
											_objectSpread({}, app.panels.field.getBlockAttributes()),
			...
			{
				'../../../js/integrations/gutenberg/modules/advanced-settings.js': 13,
				'../../../js/integrations/gutenberg/modules/background-styles.js': 15,
				'../../../js/integrations/gutenberg/modules/button-styles.js': 16,
				'../../../js/integrations/gutenberg/modules/common.js': 17,
				'../../../js/integrations/gutenberg/modules/container-styles.js': 18,
				'../../../js/integrations/gutenberg/modules/education.js': 19,
				'../../../js/integrations/gutenberg/modules/field-styles.js': 20,
				'../../../js/integrations/gutenberg/modules/themes-panel.js': 21,
			},
		],
		13: [
			function (require, module, exports) {
						...
						getFields: function getFields(props) {
							...
							if (
								...
								!(
									props !== null &&
									props !== void 0 &&
									(_props$attributes = props.attributes) !== null &&
									_props$attributes !== void 0 &&
									_props$attributes.formId
								)
							) {
								return null;
							}
			...
			function (require, module, exports) {
				...
				var _default = (exports.default = (function () {
					...
					var app = {
									...
									/*#__PURE__*/ React.createElement(
										...
										/*#__PURE__*/ React.createElement(
											...
											/*#__PURE__*/ React.createElement(SelectControl, {
												...
												onChange: function onChange(value) {
													return app.setContainerBackgroundImageWrapper(
														props,
														handlers,
														value,
														lastBgImage,
													...
													/*#__PURE__*/ React.createElement(
														...
														/*#__PURE__*/ React.createElement(
															Button,
															{
																...
																className: 'wpforms-gutenberg-form-selector-media-library-button',
																onClick:
																	stockPhotos === null || stockPhotos === void 0
																		? void 0
																		: stockPhotos.openModal.bind(
																				null,
																				props,
																				handlers,
																				'bg-styles',
										...
										/*#__PURE__*/ React.createElement(
											...
											/*#__PURE__*/ React.createElement(
												...
												/*#__PURE__*/ React.createElement(
													'div',
													null,
													/*#__PURE__*/ React.createElement(_backgroundPreview.default, {
														attributes: props.attributes,
														onRemoveBackground: function onRemoveBackground() {
															app.onRemoveBackground(
																setShowBackgroundPreview,
																handlers,
																setLastBgImage
															);
														...
														onPreviewClicked: function onPreviewClicked() {
															if (props.attributes.backgroundImage === 'library') {
																return app.openMediaLibrary(
																	props,
																	handlers,
																	setShowBackgroundPreview
																);
															}
															return stockPhotos === null || stockPhotos === void 0
																? void 0
																: stockPhotos.openModal(
																		props,
																		handlers,
																		'bg-styles',
																		setShowBackgroundPreview
						 ...
						 */
						setContainerBackgroundImageWrapper: function setContainerBackgroundImageWrapper(
							props,
							handlers,
							value,
							lastBgImage,
						 ...
						 * @return {boolean} True if the value was set, false otherwise.
						 */
						setContainerBackgroundPosition: function setContainerBackgroundPosition(
							container,
							value
						) {
							...
							return /*#__PURE__*/ React.createElement(
								...
								/*#__PURE__*/ React.createElement(
									...
									/*#__PURE__*/ React.createElement(PanelColorSettings, {
										...
										enableAlpha: true,
										showTitle: false,
										className: formSelectorCommon.getColorPanelClass(
											props.attributes.buttonBorderStyle
										),
										colorSettings: [
											{
									...
									/*#__PURE__*/ React.createElement(
										...
										{
											className:
												'wpforms-gutenberg-form-selector-legend wpforms-button-color-notice',
										},
				...
				var _default = (exports.default = (function (document, window, $) {
					...
					var app = {
							...
							registerBlockType('wpforms/form-selector', {
								...
								edit: function edit(props) {
									...
									if (
										attributes &&
										attributes.formId &&
										app.isFormAvailable(attributes.formId) === false
									) {
						...
						initDefaults: function initDefaults() {
							...
							commonAttributes = _objectSpread(
								_objectSpread({}, commonAttributes),
						 ...
						 */
						maybeSubscribeToBlockEvents: function maybeSubscribeToBlockEvents(
							subscriberProps,
							subscriberHandlers,
							subscriberBlockOptions
						) {
						 ...
						 */
						subscriberDeleteTheme: function subscriberDeleteTheme(
							subscriberProps,
							subscriberBlockOptions
						) {
							return function (e, themeSlug, triggerProps) {
								...
								if (
									(subscriberProps === null ||
									subscriberProps === void 0 ||
									(_subscriberProps$attr = subscriberProps.attributes) === null ||
									_subscriberProps$attr === void 0
										? void 0
										: _subscriberProps$attr.theme) !== themeSlug
								) {
									return;
								}
								if (
									!(
										subscriberBlockOptions !== null &&
										subscriberBlockOptions !== void 0 &&
										(_subscriberBlockOptio = subscriberBlockOptions.panels) !== null &&
										_subscriberBlockOptio !== void 0 &&
										_subscriberBlockOptio.themes
									)
								) {
									return;
								}
						 ...
						 * @return {Function} Event handler.
						 */
						subscriberUpdateTheme: function subscriberUpdateTheme(
							subscriberProps,
							subscriberBlockOptions
						) {
							return function (e, themeSlug, themeData, triggerProps) {
								...
								if (
									(subscriberProps === null ||
									subscriberProps === void 0 ||
									(_subscriberProps$attr2 = subscriberProps.attributes) === null ||
									_subscriberProps$attr2 === void 0
										? void 0
										: _subscriberProps$attr2.theme) !== themeSlug
								) {
									return;
								}
								if (
									!(
										subscriberBlockOptions !== null &&
										subscriberBlockOptions !== void 0 &&
										(_subscriberBlockOptio2 = subscriberBlockOptions.panels) !== null &&
										_subscriberBlockOptio2 !== void 0 &&
										_subscriberBlockOptio2.themes
									)
								) {
									return;
								}
						 ...
						 * @return {Function} Event handler.
						 */
						subscriberSetTheme: function subscriberSetTheme(
							subscriberProps,
							subscriberBlockOptions
						) {
							// noinspection JSUnusedLocalSymbols
							return function (e, block, themeSlug, triggerProps) {
								...
								if (
									!(
										subscriberBlockOptions !== null &&
										subscriberBlockOptions !== void 0 &&
										(_subscriberBlockOptio3 = subscriberBlockOptions.panels) !== null &&
										_subscriberBlockOptio3 !== void 0 &&
										_subscriberBlockOptio3.themes
									)
								) {
									return;
								}
						...
						jsxParts: {
								...
								return /*#__PURE__*/ React.createElement(
									...
									/*#__PURE__*/ React.createElement(
										...
										/*#__PURE__*/ React.createElement(
											...
											/*#__PURE__*/ React.createElement('strong', null, strings.panel_notice_head),
								...
								return /*#__PURE__*/ React.createElement(
									...
									/*#__PURE__*/ React.createElement(
										...
										/*#__PURE__*/ React.createElement(
											...
											{
												className:
													'wpforms-gutenberg-panel-notice wpforms-warning wpforms-empty-form-notice',
												style: {
													display: 'block',
												},
											},
											/*#__PURE__*/ React.createElement(
												'strong',
												null,
												__('You haven’t created a form, yet!', 'wpforms-lite')
											),
							 ...
							 */
							getStyleSettings: function getStyleSettings(
								props,
								handlers,
								sizeOptions,
								blockOptions,
							...
							getBlockPlaceholder: function getBlockPlaceholder(attributes, handlers, formOptions) {
								var isFormNotAvailable =
									attributes.formId && !app.isFormAvailable(attributes.formId);
								return /*#__PURE__*/ React.createElement(
									Placeholder,
									{
						...
						hasPageBreak: function hasPageBreak(forms, formId) {
							...
							var fields =
								(_JSON$parse = JSON.parse(currentForm.post_content)) === null ||
								_JSON$parse === void 0
									? void 0
									: _JSON$parse.fields;
						...
						hasRating: function hasRating(forms, formId) {
							...
							var fields =
								(_JSON$parse2 = JSON.parse(currentForm.post_content)) === null ||
								_JSON$parse2 === void 0
									? void 0
									: _JSON$parse2.fields;
							return Object.values(fields).some(function (field) {
						...
						getBlockContainer: function getBlockContainer(props) {
							...
							if (!block) {
								...
								block =
									editorCanvas === null || editorCanvas === void 0
										? void 0
										: editorCanvas.contentWindow.document.querySelector(blockSelector);
							}
							return block;
						},
						/**
						 ...
						 * @param {Object}  props     Block properties.
						 */
						updatePreviewCSSVarValue: function updatePreviewCSSVarValue(
							attribute,
							value,
							container,
							props
								...
								case 'container-shadow-size':
									for (var key in sizes[property][value]) {
										container.style.setProperty(
											'--wpforms-'.concat(property, '-').concat(key),
						 ...
						 */
						toggleFieldBorderNoneCSSVarValue: function toggleFieldBorderNoneCSSVarValue(
							container,
							set
						) {
						 ...
						 */
						maybeSetButtonAltBackgroundColor: function maybeSetButtonAltBackgroundColor(
							value,
							buttonBorderColor,
							container
						) {
						 ...
						 * @param {Object} container             Form container.
						 */
						maybeSetButtonAltTextColor: function maybeSetButtonAltTextColor(
							value,
							buttonBackgroundColor,
							buttonBorderColor,
							container
						 ...
						 * @param {Object} container             Form container.
						 */
						maybeUpdateAccentColor: function maybeUpdateAccentColor(
							color,
							buttonBackgroundColor,
							container
						) {
							...
							return {
								...
								maybeToggleDropdown: function maybeToggleDropdown(props, attribute) {
									...
									var menu = document.querySelector(
										'#wpforms-form-'.concat(formId, ' .choices__list.choices__list--dropdown')
									);
									var classicMenu = document.querySelector(
										'#wpforms-form-'.concat(formId, ' .wpforms-field-select-style-classic select')
									);
									if (attribute === 'fieldMenuColor') {
										...
										dropdownTimeout = setTimeout(function () {
											var toClose = document.querySelector(
												'#wpforms-form-'.concat(formId, ' .choices__list.choices__list--dropdown')
											);
											if (toClose) {
								...
								pasteSettings: function pasteSettings(value) {
									...
									var themeSlug =
										app.panels.themes.maybeCreateCustomThemeFromAttributes(pasteAttributes);
									app.setBlockRuntimeStateVar(
										props.clientId,
										'prevAttributesState',
										props.attributes
						...
						getBlockRuntimeStateVar: function getBlockRuntimeStateVar(clientId, varName) {
							...
							return (_blocks$clientId = blocks[clientId]) === null || _blocks$clientId === void 0
								? void 0
								: _blocks$clientId[varName];
						},
						/**
						...
						initLeadFormSettings: function initLeadFormSettings(block) {
							...
							if (
								!(
									block !== null &&
									block !== void 0 &&
									(_block$dataset = block.dataset) !== null &&
									_block$dataset !== void 0 &&
									_block$dataset.block
								)
							) {
								return;
							}
						...
						updateAccentColors: function updateAccentColors(detail) {
							...
							if (
								!wpforms_gutenberg_form_selector.is_modern_markup ||
								!(
									(_window$WPForms = window.WPForms) !== null &&
									_window$WPForms !== void 0 &&
									_window$WPForms.FrontendModern
								) ||
								!(detail !== null && detail !== void 0 && detail.block)
							) {
								return;
							}
						...
						initRepeaterField: function initRepeaterField(formId) {
							...
							$rowButtons.each(function () {
								...
								var margin =
									(labelStyle === null || labelStyle === void 0
										? void 0
										: labelStyle.getPropertyValue('--wpforms-field-size-input-spacing')) || 0;
				...
				var _default = (exports.default = (function ($) {
					...
					var app = {
						...
						showProModal: function showProModal(panel, feature) {
							var type = 'pro';
							var message = wpforms_education.upgrade[type].message_plural.replace(
								/%name%/g,
								feature
							);
							var utmContent = {
								...
								buttons: {
									confirm: {
										...
										action: function action() {
											window.open(
												WPFormsEducation.core.getUpgradeURL(utmContent[panel], type),
												'_blank'
											);
							...
							return /*#__PURE__*/ React.createElement(
								...
								/*#__PURE__*/ React.createElement(
									...
									/*#__PURE__*/ React.createElement(PanelColorSettings, {
										...
										showTitle: false,
										className: formSelectorCommon.getColorPanelClass(
											props.attributes.fieldBorderStyle
										),
										colorSettings: [
											{
					...
					var app = {
						...
						events: function events() {
							wp.data.subscribe(function () {
								...
								var isSavingPost =
									(_wp$data$select = wp.data.select('core/editor')) === null ||
									_wp$data$select === void 0
										? void 0
										: _wp$data$select.isSavingPost();
								var isAutosavingPost =
									(_wp$data$select2 = wp.data.select('core/editor')) === null ||
									_wp$data$select2 === void 0
										? void 0
										: _wp$data$select2.isAutosavingPost();
								var isSavingWidget =
									(_wp$data$select3 = wp.data.select('core/edit-widgets')) === null ||
									_wp$data$select3 === void 0
										? void 0
										: _wp$data$select3.isSavingWidgetAreas();
								var currentPost =
									(_wp$data$select4 = wp.data.select('core/editor')) === null ||
									_wp$data$select4 === void 0
										? void 0
										: _wp$data$select4.getCurrentPost();
								var isBlockOrTemplate =
									(currentPost === null ||
									currentPost === void 0 ||
									(_currentPost$type = currentPost.type) === null ||
									_currentPost$type === void 0
										? void 0
										: _currentPost$type.includes('wp_template')) ||
									(currentPost === null ||
									currentPost === void 0 ||
									(_currentPost$type2 = currentPost.type) === null ||
									_currentPost$type2 === void 0
										? void 0
										: _currentPost$type2.includes('wp_block'));
						...
						getAllThemes: function getAllThemes() {
							return _objectSpread(
								_objectSpread({}, themesData.custom || {}),
								themesData.wpforms || {}
							);
						},
						/**
						...
						getEnabledThemes: function getEnabledThemes() {
							...
							enabledThemes = Object.keys(allThemes).reduce(function (acc, key) {
								...
								if (
									(_allThemes$key$settin = allThemes[key].settings) !== null &&
									_allThemes$key$settin !== void 0 &&
									_allThemes$key$settin.fieldSize &&
									!allThemes[key].disabled
								) {
						...
						updateEnabledThemes: function updateEnabledThemes(slug, theme) {
							...
							enabledThemes = _objectSpread(
								_objectSpread({}, enabledThemes),
								{},
								_defineProperty({}, slug, theme)
							);
						},
						/**
						...
						isDisabledTheme: function isDisabledTheme(slug) {
							...
							return !(
								(_app$getEnabledThemes = app.getEnabledThemes()) !== null &&
								_app$getEnabledThemes !== void 0 &&
								_app$getEnabledThemes[slug]
							);
						},
						/**
						...
						isWPFormsTheme: function isWPFormsTheme(slug) {
							...
							return Boolean(
								(_themesData$wpforms$s = themesData.wpforms[slug]) === null ||
									_themesData$wpforms$s === void 0
									? void 0
									: _themesData$wpforms$s.settings
							);
						},
						/**
						...
						getCurrentStyleAttributes: function getCurrentStyleAttributes(props) {
							...
							var defaultAttributes = Object.keys(
								(_themesData$wpforms$d = themesData.wpforms.default) === null ||
									_themesData$wpforms$d === void 0
									? void 0
									: _themesData$wpforms$d.settings
							);
							...
							for (var key in defaultAttributes) {
								...
								currentStyleAttributes[attr] =
									(_props$attributes$att = props.attributes[attr]) !== null &&
									_props$attributes$att !== void 0
										? _props$attributes$att
										: '';
							}
						...
						maybeCreateCustomTheme: function maybeCreateCustomTheme(props) {
							...
							if (
								isWPFormsTheme &&
								JSON.stringify(
									(_themesData$wpforms$p = themesData.wpforms[props.attributes.theme]) === null ||
										_themesData$wpforms$p === void 0
										? void 0
										: _themesData$wpforms$p.settings
								) === JSON.stringify(currentStyles)
							) {
								return false;
							}
							var prevAttributes = formSelectorCommon.getBlockRuntimeStateVar(
								props.clientId,
								'prevAttributesState'
							);
						 ...
						 */
						maybeCreateCustomThemeFromAttributes: function maybeCreateCustomThemeFromAttributes(
							attributes
						) {
							...
							var isExistingTheme = Boolean(
								existingTheme === null || existingTheme === void 0 ? void 0 : existingTheme.settings
							);
							...
							if (isExistingTheme) {
								for (var i in keys) {
									var key = keys[i];
									if (
										!existingTheme.settings[key] ||
										existingTheme.settings[key] !== attributes[key]
									) {
							...
							for (var _i in defaultAttributes) {
								...
								newSettings[attr] =
									(_attributes$attr = attributes[attr]) !== null && _attributes$attr !== void 0
										? _attributes$attr
										: '';
							}
							...
							themesData.custom[newThemeSlug] = {
								name:
									(_attributes$themeName = attributes.themeName) !== null &&
									_attributes$themeName !== void 0
										? _attributes$themeName
										: strings.theme_custom,
						 ...
						 * @param {Object} props     Block properties.
						 */
						updateCustomThemeAttribute: function updateCustomThemeAttribute(
							attribute,
							value,
							props
						) {
						 ...
						 */
						getThemesPanel: function getThemesPanel(
							props,
							formSelectorCommonModule,
							stockPhotosModule
						) {
							// eslint-disable-line max-lines-per-function, complexity
							...
							return /*#__PURE__*/ React.createElement(
								...
								/*#__PURE__*/ React.createElement(
									...
									{
										className:
											'wpforms-gutenberg-panel-notice wpforms-warning wpforms-use-modern-notice',
										style: modernNoticeStyles,
									},
									/*#__PURE__*/ React.createElement('strong', null, strings.use_modern_notice_head),
								...
								/*#__PURE__*/ React.createElement(
									...
									{
										className:
											'wpforms-gutenberg-panel-notice wpforms-warning wpforms-lead-form-notice',
										style: {
						...
						getThemeFromFormSettings: function getThemeFromFormSettings(formData) {
							...
							if (
								!(
									(_formData$settings = formData.settings) !== null &&
									_formData$settings !== void 0 &&
									_formData$settings.themes
								) ||
								!formData.settings.themes.wpformsTheme
							) {
								return 'default';
							}
						...
						getThemeNameFromFormSettings: function getThemeNameFromFormSettings(formData) {
							...
							if (
								!(
									(_formData$settings2 = formData.settings) !== null &&
									_formData$settings2 !== void 0 &&
									_formData$settings2.themes
								) ||
								!formData.settings.themes.themeName
							) {
								return 'Default';
							}
						...
						updateThemeSettings: function updateThemeSettings(props) {
							...
							var themeSettings =
								((_themesData$wpforms$p2 = themesData.wpforms[props.attributes.theme]) === null ||
								_themesData$wpforms$p2 === void 0
									? void 0
									: _themesData$wpforms$p2.settings) ||
								((_themesData$custom$pr = themesData.custom[props.attributes.theme]) === null ||
								_themesData$custom$pr === void 0
									? void 0
									: _themesData$custom$pr.settings);
							...
							state === null ||
								state === void 0 ||
								(_state$stockPhotos = state.stockPhotos) === null ||
								_state$stockPhotos === void 0 ||
								_state$stockPhotos.onSelectTheme(
									props.attributes.theme,
									props,
									app,
									commonHandlers
						...
						getThemesItemsJSX: function getThemesItemsJSX(props) {
							...
							for (var key in themes) {
								...
								theme = _objectSpread(
									_objectSpread({}, allThemesData.default),
									allThemesData[slug] || {}
								);
								theme.settings = _objectSpread(
									_objectSpread({}, allThemesData.default.settings),
									theme.settings || {}
								);
						...
						getThemesItemJSX: function getThemesItemJSX(slug, theme) {
							...
							var title =
								((_theme$name = theme.name) === null || _theme$name === void 0
									? void 0
									: _theme$name.length) > 0
									? theme.name
									: strings.theme_noname;
						...
						getEventHandlers: function getEventHandlers(props) {
							...
							var handlers = {
								...
								selectTheme: function selectTheme(value) {
									...
									state === null ||
										state === void 0 ||
										(_state$stockPhotos2 = state.stockPhotos) === null ||
										_state$stockPhotos2 === void 0 ||
										_state$stockPhotos2.onSelectTheme(value, props, app, commonHandlers);
									var block = formSelectorCommon.getBlockContainer(props);
						...
						deleteThemeModal: function deleteThemeModal(props, deleteThemeSlug, handlers) {
							var confirm = strings.theme_delete_confirm.replace(
								'%1$s',
								'<b>'.concat(props.attributes.themeName, '</b>')
							);
							var content = '<p class="wpforms-theme-delete-text">'
								.concat(confirm, ' ')
								.concat(strings.theme_delete_cant_undone, '</p>');
							$.confirm({
								...
								buttons: {
									confirm: {
										...
										action: function action() {
											...
											// Trigger event for developers.
											el.$window.trigger('wpformsFormSelectorDeleteTheme', [
												deleteThemeSlug,
												props,
											]);
										},
