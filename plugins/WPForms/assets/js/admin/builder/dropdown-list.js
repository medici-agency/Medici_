...
WPForms.Admin.Builder.DropdownList =
	WPForms.Admin.Builder.DropdownList ||
	(function (document, window, $) {
		...
		function DropdownList(options) {
			...
			self.open = function () {
				...
				self.$builder.on('click.DropdownList', function (e) {
					...
					const excludedSelectors =
						'.button-insert-field, .wpforms-smart-tags-enabled, .wpforms-show-smart-tags, .mce-ico';
			...
			self.generateHtml = function () {
				...
				const itemFormat =
					typeof self.options.itemFormat === 'function'
						? self.options.itemFormat
						: defaultOptions.itemFormat;
			...
			self.attach = function () {
				...
				self.$container = self.options.container
					...
					: self.$button.parent();
				self.$scrollableContainer = self.options.scrollableContainer
					? $(self.options.scrollableContainer)
					: null;
			...
			self.setPosition = function () {
				...
				let top =
					buttonOffset.top - containerOffset.top - dropdownHeight - self.options.buttonDistance;
			...
			self.events = function () {
				...
				if (self.options.search.enabled) {
					...
					self.$el
						.find('.wpforms-builder-dropdown-list-search-close')
						.on('click', self.clearSearch);
				}
			};
