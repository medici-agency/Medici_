 ...
 */
const WPFormsPagesPrivacyCompliance =
	window.WPFormsPagesPrivacyCompliance ||
	(function (document, window, $) {
		...
		const app = {
			...
			init: () => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.init()" has been deprecated, please use the new "WPFormsPagesCommon.init()" function instead!'
			...
			ready: () => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.ready()" has been deprecated, please use the new "WPFormsPagesCommon.ready()" function instead!'
				); // eslint-disable-line no-console
			...
			initVars: () => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.initVars()" has been deprecated, please use the new "WPFormsPagesCommon.initVars()" function instead!'
				); // eslint-disable-line no-console
			...
			events: () => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.events()" has been deprecated, please use the new "WPFormsPagesCommon.events()" function instead!'
				); // eslint-disable-line no-console
			...
			stepInstallClick: (e) => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.stepInstallClick()" has been deprecated, please use the new "WPFormsPagesCommon.stepInstallClick()" function instead!'
				); // eslint-disable-line no-console
			...
			stepInstallDone: (res, $btn, action) => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.stepInstallDone()" has been deprecated, please use the new "WPFormsPagesCommon.stepInstallDone()" function instead!'
				); // eslint-disable-line no-console
				...
				if (success) {
					...
					const activationFail =
							...
							'activate' === action,
						url = !activationFail
							? wpforms_pluginlanding.wpconsent_manual_install_url
							: wpforms_pluginlanding.wpconsent_manual_activate_url,
						msg = !activationFail
			...
			stepInstallPluginStatus: () => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.stepInstallPluginStatus()" has been deprecated, please use the new "WPFormsPagesCommon.stepInstallPluginStatus()" function instead!'
				); // eslint-disable-line no-console
			...
			stepInstallPluginStatusDone: (res) => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.stepInstallPluginStatusDone()" has been deprecated, please use the new "WPFormsPagesCommon.stepInstallPluginStatusDone()" function instead!'
				); // eslint-disable-line no-console
				...
				if (res.data.setup_status > 0) {
					...
					if (res.data.license_level === 'pro') {
						...
						el.$stepAddonNum.attr(
							'src',
							el.$stepAddonNum.attr('src').replace('step-3.svg', 'step-complete.svg')
						);
					} else {
			...
			gotoURL: (e) => {
				...
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.gotoURL()" has been deprecated, please use the new "WPFormsPagesCommon.gotoURL()" function instead!'
				); // eslint-disable-line no-console
			...
			showSpinner: ($el) => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.showSpinner()" has been deprecated, please use the new "WPFormsPagesCommon.showSpinner()" function instead!'
				); // eslint-disable-line no-console
			...
			hideSpinner: ($el) => {
				console.warn(
					'WARNING! Function "WPFormsPagesPrivacyCompliance.hideSpinner()" has been deprecated, please use the new "WPFormsPagesCommon.hideSpinner()" function instead!'
				); // eslint-disable-line no-console
