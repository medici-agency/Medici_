...
var WPFormsWPCode =
	...
	(function (document, window, $) {
		...
		const app = {
			 ...
			 */
			ready() {
				app.snippetSearch = new List('wpforms-wpcode-snippets-list', {
			...
			installSnippet() {
				...
				$badge
					.addClass('wpforms-wpcode-installing-in-progress')
					.text(wpformsWpcodeVars.installing_text);
			...
			installPlugin() {
				...
				$.post(wpforms_admin.ajax_url, data).done(function () {
					location.reload();
				});
			},
		};
